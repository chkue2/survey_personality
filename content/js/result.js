...
$(function(){
    var resJson = {
        seeking: {
            ...
            img: '/content/media/img/seeking-type-3.jpg'
        },
        spurt: {
            type: '스릴추구 막판스퍼트형',
            ...
            img: '/content/media/img/spurt-type-3.jpg'
        },
        safety: {
            type: '방탄조끼 안정지향형',
            ...
            img: '/content/media/img/safety-type-3.jpg'
        },
        growth: {
            type: '강철멘탈 성장지향형',
            ...
            img: '/content/media/img/growth-type-3.jpg'
        }
    };
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [v1, v2, v3, v4, v5],
                borderWidth: 1,
                backgroundColor: 'rgba(216, 174, 112, 0.7)'
            }]
        },
        options: {
            responsive: false,
